...
package top.znsd.starter.data.mp.autoconfigure;
...
import top.znsd.starter.data.mp.autoconfigure.idgenerator.MyBatisPlusIdGeneratorConfiguration;
import top.znsd.starter.data.mp.handler.CompositeBaseEnumTypeHandler;
...
public class MybatisPlusAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Znsd Starter] - Auto Configuration 'MyBatis Plus' completed initialization.");
    }
}
