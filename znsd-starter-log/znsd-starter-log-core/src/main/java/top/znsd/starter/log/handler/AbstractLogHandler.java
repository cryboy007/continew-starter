...
package top.znsd.starter.log.handler;
...
import top.znsd.starter.log.annotation.Log;
import top.znsd.starter.log.enums.Include;
import top.znsd.starter.log.model.AccessLogContext;
import top.znsd.starter.log.model.AccessLogProperties;
import top.znsd.starter.log.model.LogRecord;
import top.znsd.starter.log.util.AccessLogUtils;
...
public abstract class AbstractLogHandler implements LogHandler {
    ...
    public void logDescription(LogRecord logRecord, Method targetMethod) {
        logRecord.setDescription("请在该接口方法上添加 @top.znsd.starter.log.annotation.Log(value) 来指定日志描述");
    ...
    public void logModule(LogRecord logRecord, Method targetMethod, Class<?> targetClass) {
        logRecord.setModule("请在该接口方法或类上添加 @top.znsd.starter.log.annotation.Log(module) 来指定所属模块");
        Log methodLog = AnnotationUtil.getAnnotation(targetMethod, Log.class);
