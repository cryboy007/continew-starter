...
package top.znsd.starter.messaging.websocket.autoconfigure;
...
import top.znsd.starter.messaging.websocket.core.WebSocketClientService;
import top.znsd.starter.messaging.websocket.core.WebSocketInterceptor;
import top.znsd.starter.messaging.websocket.dao.WebSocketSessionDao;
import top.znsd.starter.messaging.websocket.dao.WebSocketSessionDaoDefaultImpl;
...
public class WebSocketAutoConfiguration {
    ...
    public WebSocketHandler webSocketHandler(WebSocketSessionDao webSocketSessionDao) {
        return new top.znsd.starter.messaging.websocket.core.WebSocketHandler(properties, webSocketSessionDao);
    }
