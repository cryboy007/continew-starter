...
package top.znsd.starter.core.autoconfigure.threadpool;
...
public class ThreadPoolExtensionProperties {
    ...
    public static class ExecutorExtensionProperties {
         ...
         * 拒绝策略
         */
        private top.znsd.starter.core.autoconfigure.threadpool.ThreadPoolExecutorRejectedPolicy rejectedPolicy = top.znsd.starter.core.autoconfigure.threadpool.ThreadPoolExecutorRejectedPolicy.CALLER_RUNS;

        public top.znsd.starter.core.autoconfigure.threadpool.ThreadPoolExecutorRejectedPolicy getRejectedPolicy() {
            return rejectedPolicy;
        }

        public void setRejectedPolicy(top.znsd.starter.core.autoconfigure.threadpool.ThreadPoolExecutorRejectedPolicy rejectedPolicy) {
