...
package top.znsd.starter.auth.satoken.autoconfigure;
...
import top.znsd.starter.auth.satoken.autoconfigure.dao.SaTokenDaoConfiguration;
...
public class SaTokenAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("[Znsd Starter] - Auto Configuration 'SaToken' completed initialization.");
    }
}
