...
package top.znsd.starter.captcha.graphic.autoconfigure;
...
import top.znsd.starter.captcha.graphic.core.GraphicCaptchaService;
...
public class GraphicCaptchaAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Znsd Starter] - Auto Configuration 'Captcha-Graphic' completed initialization.");
    }
}
